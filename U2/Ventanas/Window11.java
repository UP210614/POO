...
public class Window11 extends JFrame implements ActionListener{
    ...
    public Window11(){
        ...
        statusLevel = new JLabel("Turno de jugador " + currentPlayer);
        statusLevel.setBounds(5, 5, 355, 20);
        statusLevel.setFont(new Font("Arial",Font.PLAIN, 18));
        statusLevel.setForeground(fontColorButton);
        statusLevel.setHorizontalAlignment(JLabel.CENTER);
        add(statusLevel);
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(checkWin()){
            statusLevel.setText("Jugador "+currentPlayer+ " gana!");
            disableButtons();
        }
        else if (isBoardFull()){
            statusLevel.setText("Empate!");
            for (int i = 0; i<3; i++){
                for ( int j = 0; j<3;j++){
            ...
            statusLevel.setText("Turno del jugador "+ currentPlayer);
        }
    }
    ...
    public static void main (String arg[]){
        ...
        Window11 catGame = new Window11();
        catGame.setBounds(0, 0, 350, 395);
        catGame.setVisible(true);
        catGame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        catGame.setResizable(false);
        catGame.setTitle("Juego del gato");
        catGame.setLocationRelativeTo(null);
        catGame.getContentPane().setBackground(new Color(0,0,0));
    }
}